...
public class FastDFSTest {
    ...
    public void testUpload() throws IOException, MyException {
        ...
        // 使用全局对象加载配置文件
        //ClientGlobal.init("/Users/admin/IdeaProjects/mall/manager-web/src/main/resources/config/client.conf");
        ...
        //String[] strings = storageClient.upload_file("/Users/admin/Pictures/Irvue/table.jpg", "jpg", null);
